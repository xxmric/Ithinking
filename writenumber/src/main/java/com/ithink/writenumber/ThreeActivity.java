...
import com.ithink.writenumber.util.mCustomProgressDialog;
...
public class ThreeActivity extends Activity {  //ThreeActivity类头部
    ...
    private void initView() {  //initView()方法头部
        ...
        // 获取书写界面布局
        LinearLayout write_layout = (LinearLayout) findViewById(R.id.LinerLayout_number);
        // 设置书写界面布局背景
    ...
    private synchronized void lodimagep(int j) {        //lodimagep()方法头部
        ...
        if (i < 25) {                            // 如果当前图片位置小于25
            ...
            // 获取图片资源id
            int imgid = getResources().getIdentifier(name, "drawable", "com.ithink.writenumber");
